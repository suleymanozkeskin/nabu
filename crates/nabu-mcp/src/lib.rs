...
fn tool_descriptions() -> Value {
    json!([
        ...
        {
            "name": "list_sessions",
            "description": "List recent captured sessions with counts and raw-file pointers. Lists across every tool by default; pass tool=\"all\" for the explicit cross-tool form or a specific tool name to narrow.",
